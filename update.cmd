@echo off
rem Update script for FarUE3 x86 only!
...
if exist %~dps0Far\farfix.cnf (far -import %~dps0Far\farfix.cnf && del /f/q farfix.cnf > nul)
if exist wg.cmd (del/f/q wg.cmd > nul)
popd
start cmd /c del /f/q %~dps0update.cmd > nul
exit /b 0 > nul