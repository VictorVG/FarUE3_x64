...
Минимальные системные требования:
 ...
 набора ограничена WinAPI), примерно 100 Мб на диске, пользователь должен
 иметь права записи в каталог данной копии Far3 (настройки хранятся в
 ...
 в код вставляет), для запуска требуется до 50 Мб оперативной памяти.
...
Некоторые антивирусы реагируют на hidcon-x*.exe как на потенциальную угрозу,
но заразы в нём нет и необходимости пересобирать hidcon-x*.exe в другом
...
A:  Обычно причина в повреждении базы "42E4AEB1-A230-44F4-B33C-F195BB654931.db"
   ...
   настройки NetBox которые повреждаются при экспорте/импорте БД, что и
...
A: Поддержки Base64 пока нет, а плагин Base64 от Maximus5 не рабочий и баг
   https://github.com/Maximus5/FarPlugins/issues/3 почти два года висит.
