...
Macro {
	area="Editor"; key="CtrlAltBS"; description="Indent right by tab size"; action = function()
Indent(true, true)
  end;
}
...
Macro {
  area="Editor"; key="AltShiftBS"; description="Indent right by space"; action = function()
Indent(false, true)
  end;
}

Macro {
  area="Editor"; key="CtrlShiftBS"; description="Indent left by space"; action = function()
Indent(false, false)
  end;
}
