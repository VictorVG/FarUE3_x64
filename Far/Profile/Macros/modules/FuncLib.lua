...
-- mod - 1 or 2 compare as: 1 - arg1 < arg2, arg1 = arg2, arg > arg2 and return
-- digital result; 2 - arg1 < arg2, arg1 >= arg2 and return logical result
--
-- Returns:
--
...
-- vCmp() - return digital for mod=1 or logical for mod=2 value is:
-- arg1 < arg2 return "-1", arg1 = arg2 return "0", arg1 = arg2 return "1"
-- or logical: arg1 < arg2 return "false", arg1 >= arg2 return "true" value
--
-- Notes: PlugVer() and PlugVerD() can retrieve version info only for installed Far plug-in's!
--
-- Usage:
--
...
typedef struct {
  ...
  DWORD  cntUsage;
  DWORD  th32ProcessID;
  intptr_t th32DefaultHeapID; // ULONG_PTR
  DWORD  th32ModuleID;
  DWORD  cntThreads;
  DWORD  th32ParentProcessID;
  LONG   pcPriClassBase;
  DWORD  dwFlags;
  CHAR   szExeFile[260]; // Path [MAX_PATH]
} PROCESSENTRY32;
...
function _G.KbdLayout()
  ...
  if far_conhost_pid == 0 then -- no conhost found probably far+conemu: GUI case
